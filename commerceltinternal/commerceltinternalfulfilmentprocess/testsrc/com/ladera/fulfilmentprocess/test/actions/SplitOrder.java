 ...
 */
package com.ladera.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(CommerceltinternalFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CommerceltinternalFulfilmentProcessConstants.PARENT_PROCESS);
