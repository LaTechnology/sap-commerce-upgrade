 ...
 */
package com.ladera.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import com.ladera.constants.YcommercewebservicesConstants;
import com.ladera.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "commerceltinternalocc.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "commerceltinternalocc.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "commerceltinternalocc.oauth2.tokenUrl";

	private static final String DESC = "commerceltinternalocc.v2.description";
	private static final String TITLE = "commerceltinternalocc.v2.title";
	private static final String VERSION = "commerceltinternalocc.v2.version";
	private static final String LICENSE = "commerceltinternalocc.v2.license";
	private static final String LICENSE_URL = "commerceltinternalocc.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "commerceltinternalocc.content.negotiation.legacy";
