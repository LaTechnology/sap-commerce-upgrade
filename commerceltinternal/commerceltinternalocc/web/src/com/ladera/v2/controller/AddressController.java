...
import com.ladera.swagger.ApiBaseSiteIdAndUserIdAndAddressParams;
import com.ladera.user.data.AddressDataList;
import com.ladera.validation.data.AddressValidationData;
...
public class AddressController extends BaseCommerceController
{
	...
	public AddressWsDTO createAddress(
			@Parameter(name = "Address object.", required = true)
			@RequestBody
	...
	@ApiBaseSiteIdAndUserIdParam
	public AddressWsDTO getAddress(@Parameter(name = "Address identifier.", required = true)
	@PathVariable
	...
	public void replaceAddress(@Parameter(name = "Address identifier.", required = true)
	@PathVariable
	final String addressId,
	...
	public void replaceAddress(@Parameter(name = "Address identifier.", required = true)
	@PathVariable
	final String addressId, @Parameter(name = "Address object.", required = true)
	@RequestBody
	final AddressWsDTO address)
	{
		validate(address, OBJECT_NAME_ADDRESS, getAddressDTOValidator());
	...
	@ApiBaseSiteIdAndUserIdAndAddressParams
	@ResponseStatus(HttpStatus.OK)
	public void updateAddress(@Parameter(name = "Address identifier.", required = true)
	@PathVariable
	final String addressId,
			final HttpServletRequest request)
	{
	...
	@ApiBaseSiteIdAndUserIdParam
	@ResponseStatus(HttpStatus.OK)
	public void removeAddress(@Parameter(name = "Address identifier.", required = true)
	@PathVariable
	final String addressId)
	{
