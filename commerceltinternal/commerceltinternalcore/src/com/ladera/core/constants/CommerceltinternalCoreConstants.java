 ...
 */
package com.ladera.core.constants;

/**
 * Global class for all CommerceltinternalCore constants. You can add global constants for your extension into this class.
 */
public final class CommerceltinternalCoreConstants extends GeneratedCommerceltinternalCoreConstants
{
	public static final String EXTENSIONNAME = "commerceltinternalcore";


	private CommerceltinternalCoreConstants()
	{
		//empty
	}
