...
import com.ladera.test.constants.CommerceltinternalTestConstants;
import com.ladera.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = CommerceltinternalTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/commerceltinternaltest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/commerceltinternaltest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/commerceltinternaltest/import/cstickets.impex");
			...
			importImpexFile(context, "/commerceltinternaltest/import/csquotes.impex");
		}
	}
}
