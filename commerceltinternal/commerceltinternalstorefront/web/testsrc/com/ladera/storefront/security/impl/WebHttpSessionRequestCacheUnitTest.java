...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/commerceltinternalstorefront/electronics/en",
						"https://electronics.local:9002/commerceltinternalstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/commerceltinternalstorefront/electronics/en",
						"https://electronics.local:9002/commerceltinternalstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/commerceltinternalstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/commerceltinternalstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/commerceltinternalstorefront/electronics/en",
						"https://electronics.local:9002/commerceltinternalstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/commerceltinternalstorefront",
						"https://electronics.local:9002/commerceltinternalstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/commerceltinternalstorefront",
						"https://electronics.local:9002/commerceltinternalstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/commerceltinternalstorefront/electronics/en",
						"https://electronics.local:9002/commerceltinternalstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
